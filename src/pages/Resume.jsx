  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start pb-12 mb-12 border-b border-border gap-6">
        ...
        <div className="flex flex-col text-sm md:text-base text-text-secondary space-y-1.5 md:text-right">
          <a
          ...
          <div className="pt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block text-xs md:text-sm font-semibold px-3.5 py-2 rounded bg-zinc-900 dark:bg-white dark:text-black text-white hover:bg-primary hover:text-background transition-all"
            >
              Download PDF CV
            </a>
          </div>
      ...
      <div className="space-y-12">
        ...
        <motion.section variants={itemVariants} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 ">
          <div className="md:col-span-3">
            <h2 className="text-xs md:text-sm uppercase tracking-wider font-semibold text-text-secondary sticky top-24">
              EXPERIENCE
            </h2>
          </div>
          ...
          <div className="md:col-span-9 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Self-Employed</h3>
                <p className="text-sm font-medium text-text-secondary">UI/UX Designer & UI Developer</p>
                <p className="text-xs md:text-sm text-text-secondary/70 mt-0.5">01/2026 – Present</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Zafer</h3>
                <p className="text-sm font-medium text-text-secondary">UI/UX Designer</p>
                <p className="text-xs md:text-sm text-text-secondary/70 mt-0.5">03/2024 – 12/2025</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Self-Employed</h3>
                <p className="text-sm font-medium text-text-secondary">UI/UX Designer & Developer</p>
                <p className="text-xs md:text-sm text-text-secondary/70 mt-0.5">10/2023 – 02/2024</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Surge Global</h3>
                <p className="text-sm font-medium text-text-secondary">UI/UX Intern</p>
                <p className="text-xs md:text-sm text-text-secondary/70 mt-0.5">07/2022 – 12/2022</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base text-text-secondary leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Vetstoria</h3>
                <p className="text-sm font-medium text-text-secondary">Web Development Intern</p>
                <p className="text-xs md:text-sm text-text-secondary/70 mt-0.5">07/2021 – 06/2022</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base text-text-secondary leading-relaxed">
        ...
        <motion.section variants={itemVariants} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 pt-6 border-t border-border">
          <div className="md:col-span-3">
            <h2 className="text-xs md:text-sm uppercase tracking-wider font-semibold text-text-secondary">
              EDUCATION
            </h2>
          </div>
          ...
          <div className="md:col-span-9 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">University of Westminster</h3>
                <p className="text-xs md:text-sm text-text-secondary/70">2019 – 2023</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base font-semibold text-text-primary">B.Sc. (Hons) in Computer Science</p>
                <p className="text-base text-text-secondary">First Class Honors with Industrial Experience</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4">
              <div className="md:col-span-5">
                <h3 className="font-bold text-text-primary text-lg">Zahira College</h3>
                <p className="text-xs md:text-sm text-text-secondary/70">2009 – 2019</p>
              </div>
              <div className="md:col-span-7">
                <p className="text-base font-semibold text-text-primary">GCE A/L & O/L</p>
                <p className="text-base text-text-secondary">Physical Science Stream</p>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section variants={itemVariants} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 pt-6 border-t border-border">
          ...
          <div className="md:col-span-9 space-y-4">
            <div>
              <span className="font-bold text-base text-text-primary">UX & Research: </span>
            ...
            <div>
              <span className="font-bold text-base text-text-primary">Design & Systems: </span>
              <span className="text-base text-text-secondary">
            ...
            <div>
              <span className="font-bold text-base text-text-primary">Web & Tech: </span>
              <span className="text-base text-text-secondary">
            ...
            <div>
              <span className="font-bold text-base text-text-primary">AI & Workflows: </span>
              <span className="text-base text-text-secondary">
